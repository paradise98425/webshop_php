...
<?php
    ...
    if(isset($_GET["productId"])){
        ...
        $products = $funcObj->FetchProductsFromProductId($_GET["productId"]);
    }
    else {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (!empty($_POST["name"]) || !empty($_POST["price"])) {
            ...
            $update = $funcObj->UpdateProduct($_GET["productId"], $_POST["name"], $_POST["price"]); 
            if($update){
                ...
                $error_message = "Product failed update";
            }
        }
        else {
