                    ...
                    <table class="shopping-cart">
                        ...
                        <?php 
                            foreach($_SESSION["shopping_cart"] as $item){
                                $total_cart_price = $total_cart_price + intval($item["product_price"]) * intval($item["product_quantity"]);
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    $product_price = intval($item["product_price"]) * intval($item["product_quantity"]);
                                    echo $product_price;
                                ?>
                            </td>
                        </tr>
